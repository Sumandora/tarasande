...
public abstract class MixinMinecraftClient implements IMinecraftClient
{
    ...
    public int hookedMin(final int a, final int b) {
        if (TarasandeMain.Companion.get().getManagerModule().get((Class<? extends ModuleTimer>)ModuleTimer.class).getEnabled()) {
            return b;
        }
        return Math.min(a, b);
    }
    ...
    public boolean hookedIsGlowing(final Entity entity) {
        return TarasandeMain.Companion.get().getManagerModule().get((Class<? extends ModuleESP>)ModuleESP.class).getEnabled() || entity.isGlowing();
    }
    ...
    public int getCurrentFps() {
        return MixinMinecraftClient.currentFps;
    }
