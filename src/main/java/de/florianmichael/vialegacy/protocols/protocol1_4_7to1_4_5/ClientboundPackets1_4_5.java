...
public enum ClientboundPackets1_4_5 implements LegacyClientboundPacketType {
	...
	ClientboundPackets1_4_5(final int id, final IPacketSplitterLogic splitter) {
		this.id = id;
		this.splitter = splitter;

		this.registerSplitter(LegacyProtocolVersion.R1_4_5);
	}
