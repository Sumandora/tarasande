...
public enum ClientboundPackets1_4_2 implements LegacyClientboundPacketType {
	...
	ClientboundPackets1_4_2(final int id, final IPacketSplitterLogic splitter) {
		this.id = id;
		this.splitter = splitter;

		this.registerSplitter(LegacyProtocolVersion.R1_4_2);
	}
