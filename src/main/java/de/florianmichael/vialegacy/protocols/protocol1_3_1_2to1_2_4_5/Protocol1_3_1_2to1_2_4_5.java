...
public class Protocol1_3_1_2to1_2_4_5 extends EnZaProtocol<ClientboundPackets1_2_4_5, ClientboundPackets1_3_1_2, ServerboundPackets1_2_4_5, ServerboundPackets1_3_1_2> {
	...
	protected void registerPackets() {
		...
		this.registerClientbound(ClientboundPackets1_2_4_5.JOIN_GAME, new PacketRemapper() {
			@Override
			public void registerMap() {
				handler(pw -> {
		...
		this.registerClientbound(ClientboundPackets1_2_4_5.GAME_EVENT, new PacketRemapper() {
			@Override
			public void registerMap() {
				handler(pw -> {
		...
		this.registerServerbound(ServerboundPackets1_3_1_2.CLICK_WINDOW, new PacketRemapper() {
			@Override
			public void registerMap() {
		...
		this.registerServerbound(ServerboundPackets1_3_1_2.CREATIVE_INVENTORY_ACTION, new PacketRemapper() {
			@Override
			public void registerMap() {
				map(Type.SHORT); // Slot
				map(Types1_7_6_10.COMPRESSED_NBT_ITEM, TypeRegistry1_2_5.COMPRESSED_NBT_ITEM); // Item
		...
		this.registerServerbound(ServerboundPackets1_3_1_2.PLAYER_BLOCK_PLACEMENT, new PacketRemapper() {
			@Override
			public void registerMap() {
		...
		this.registerServerbound(ServerboundPackets1_3_1_2.PLAYER_ABILITIES, new PacketRemapper() {
			@Override
			public void registerMap() {
				handler((pw) -> {
		...
		this.registerClientbound(ClientboundPackets1_2_4_5.ENTITY_EQUIPMENT, new PacketRemapper() {
			...
			public void registerMap() {
				...
				handler((pw) -> {
					...
					pw.write(Types1_7_6_10.COMPRESSED_NBT_ITEM, id == -1 ? null : new DataItem(id, (byte) 1, damage, null));
				});
			}
		});

		this.registerClientbound(ClientboundPackets1_2_4_5.DESTROY_ENTITIES, new PacketRemapper() {
			@Override
			public void registerMap() {
				handler((pw) -> {
					final int entityId = pw.read(Type.INT);
		...
		this.registerClientbound(ClientboundPackets1_2_4_5.ENTITY_METADATA, new PacketRemapper() {
			@Override
			public void registerMap() {
				map(Type.INT); // Entity-Id
		...
		this.registerClientbound(ClientboundPackets1_2_4_5.BLOCK_ENTITY_DATA, new PacketRemapper() {
			@Override
			public void registerMap() {
				map(Type.INT); // X-Position
				...
				handler((pw) -> {
					...
					if (pw.get(Type.UNSIGNED_BYTE, 0) == 1) {
						...
						pw.write(Types1_7_6_10.COMPRESSED_NBT, tag);
					}
				});
			}
		});
		...
		this.registerClientbound(ClientboundPackets1_2_4_5.CREATIVE_INVENTORY_ACTION, new PacketRemapper() {
			@Override
			public void registerMap() {
				map(Type.SHORT); // Slot
				map(TypeRegistry1_2_5.COMPRESSED_NBT_ITEM, Types1_7_6_10.COMPRESSED_NBT_ITEM); // Item
		...
		this.registerClientbound(ClientboundPackets1_2_4_5.PLAYER_ABILITIES, new PacketRemapper() {
			@Override
			public void registerMap() {
				handler((pw) -> {
		...
		this.registerClientbound(ClientboundPackets1_2_4_5.SPAWN_PLAYER, new PacketRemapper() {
			@Override
			public void registerMap() {
				map(Type.INT); // Entity-Id
		...
		this.registerClientbound(ClientboundPackets1_2_4_5.SPAWN_MOB, new PacketRemapper() {
			@Override
			public void registerMap() {
				map(Type.INT); // Entity-Id
		...
		this.registerClientbound(ClientboundPackets1_2_4_5.BLOCK_ACTION, new PacketRemapper() {
			@Override
			public void registerMap() {
				map(Type.INT);
				map(Type.SHORT);
		...
		this.registerClientbound(ClientboundPackets1_2_4_5.BLOCK_CHANGE, new PacketRemapper() {
			@Override
			public void registerMap() {
				map(Type.INT); // X-Position
				map(Type.UNSIGNED_BYTE); // Y-Position
