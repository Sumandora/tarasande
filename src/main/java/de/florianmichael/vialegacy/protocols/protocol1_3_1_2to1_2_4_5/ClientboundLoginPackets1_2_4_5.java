...
public enum ClientboundLoginPackets1_2_4_5 implements LegacyClientboundPacketType {
	...
	ClientboundLoginPackets1_2_4_5(final int id, final IPacketSplitter splitter) {
		this.id = id;
