package net.tarasandedevelopment.tarasande.panelsystem.impl.elements
...
open class PanelElements<T : ElementWidth>(title: String, x: Double, y: Double, minWidth: Double, minHeight: Double, fixed: Boolean = false) : Panel(title, x, y, minWidth, minHeight, fixed = fixed) {
