 ...
 */
class PanelHypixelOverlay(x: Double, y: Double, screenCheatMenu: ScreenCheatMenu) : Panel("Hypixel Overlay", x, y, 200.0, FontWrapper.fontHeight().toDouble(), background = false, fixed = true) {
