...
class PanelArrayList(x: Double, y: Double, screenCheatMenu: ScreenCheatMenu) : Panel("Array List", x, y, 75.0, FontWrapper.fontHeight().toDouble(), background = false, resizable = false, fixed = true) {
