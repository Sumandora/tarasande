...
class PanelEffects(x: Double, y: Double, screenCheatMenu: ScreenCheatMenu) : Panel("Effects", x, y, 75.0, FontWrapper.fontHeight().toDouble(), background = false, resizable = false, fixed = true) {
