...
class PanelArmor(x: Double, y: Double, screenCheatMenu: ScreenCheatMenu) : Panel("Armor", x, y, 75.0, FontWrapper.fontHeight().toDouble(), background = false, resizable = false, fixed = true) {
