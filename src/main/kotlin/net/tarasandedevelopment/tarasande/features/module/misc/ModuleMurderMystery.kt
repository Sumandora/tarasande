...
import net.tarasandedevelopment.tarasande.features.module.combat.ModuleAntiBot
    ...
    init {
        ...
        registerEvent(EventPacket::class.java) { event ->
            if (event.type == EventPacket.Type.RECEIVE) if (event.packet is PlayerRespawnS2CPacket) {
                ...
                if (TarasandeMain.get().managerModule.get(net.tarasandedevelopment.tarasande.features.module.combat.ModuleAntiBot::class.java).isBot(player)) return@registerEvent
