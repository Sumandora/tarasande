...
class ScreenBetterSlotListAddons : ScreenBetterSlotList(46, MinecraftClient.getInstance().textRenderer.fontHeight * 2 + 5) {

    private val list = TarasandeMain.get().managerAddon.list.map { p -> ScreenBetterSlotListEntryAddon(p) }
    ...
    class ScreenBetterSlotListEntryAddon(val addon: Addon) : ScreenBetterSlotListEntry() {
