...
class PanelElementsCategory(private val moduleCategory: ModuleCategory, x: Double, y: Double) : PanelElements<ElementModule>(StringUtil.formatEnumTypes(moduleCategory.name), x, y, 150.0, 100.0) {
    init {
