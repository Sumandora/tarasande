...
class AbstractClientPlayerEntityDummy(val profile: GameProfile, private val skinImage: Identifier, private val capeImage: Identifier) : AbstractClientPlayerEntity(ClientWorldDummy.create(), profile) {
