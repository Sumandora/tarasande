...
import net.tarasandedevelopment.tarasande.util.render.font.FontWrapper.fill
import net.tarasandedevelopment.tarasande.util.render.font.FontWrapper.fillCircle
import net.tarasandedevelopment.tarasande.util.render.font.FontWrapper.fillHorizontalGradient
import net.tarasandedevelopment.tarasande.util.render.font.FontWrapper.fillVerticalGradient
import net.tarasandedevelopment.tarasande.util.render.font.FontWrapper.isHovered
import net.tarasandedevelopment.tarasande.util.render.font.FontWrapper.outlinedCircle
import net.tarasandedevelopment.tarasande.util.render.font.FontWrapper.outlinedFill
...
class ElementValueComponentColor(value: Value) : ElementValueComponent(value) {
    ...
    override fun mouseClicked(mouseX: Double, mouseY: Double, button: Int): Boolean {
        ...
        if (!this.isAccent() && isHovered(mouseX, mouseY, width - FontWrapper.getWidth(lockToAccentColorText) / 2.0f, getPickerHeight(), width, getPickerHeight() + FontWrapper.fontHeight() / 2.0f)) {
