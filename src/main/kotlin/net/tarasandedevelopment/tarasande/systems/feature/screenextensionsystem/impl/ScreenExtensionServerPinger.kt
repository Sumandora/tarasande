    ...
    init {
        EventDispatcher.add(EventTick::class.java) { event ->
            if (event.state == EventTick.State.PRE) {
                if (pingWhenInGame.value && MinecraftClient.getInstance().currentScreen !is GameMenuScreen && MinecraftClient.getInstance().player != null && MinecraftClient.getInstance().world != null) {
