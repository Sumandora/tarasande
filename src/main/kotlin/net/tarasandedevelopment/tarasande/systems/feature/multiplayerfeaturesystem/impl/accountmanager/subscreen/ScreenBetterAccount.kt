...
class ScreenBetterAccount(
    ...
    private var implementationClass: Class<out Account> = TarasandeMain.managerMultiplayerFeature().get(MultiplayerFeatureAccountManager::class.java).screenBetterSlotListAccountManager.managerAccount.list.first()
    ...
    override fun init() {
        ...
        addDrawableChild(
            ButtonWidget(
                ...
                implementationClass = TarasandeMain.managerMultiplayerFeature().get(MultiplayerFeatureAccountManager::class.java).screenBetterSlotListAccountManager.managerAccount.let { it.list[(it.list.indexOf(implementationClass) + 1) % it.list.size ] }
                accountImplementation = implementationClass.getDeclaredConstructor().newInstance()
                init()
