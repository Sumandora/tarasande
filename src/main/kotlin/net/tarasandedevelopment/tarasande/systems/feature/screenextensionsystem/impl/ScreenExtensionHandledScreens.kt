...
class ScreenExtensionHandledScreensClientsideClose : ScreenExtensionButton<Screen>("Clientside close", HandledScreen::class.java, LecternScreen::class.java, DeathScreen::class.java) {
...
class ScreenExtensionHandledScreensServersideClose : ScreenExtensionButton<Screen>("Serverside close", HandledScreen::class.java, LecternScreen::class.java) {
