...
class ScreenExtensionHandledScreensClientsideClose : ScreenExtension<Screen>("Clientside close", HandledScreen::class.java, LecternScreen::class.java, DeathScreen::class.java) {
...
class ScreenExtensionHandledScreensServersideClose : ScreenExtension<Screen>("Serverside close", HandledScreen::class.java, LecternScreen::class.java) {
