package net.tarasandedevelopment.tarasande.systems.feature.modulesystem.panel.elements
...
class ElementModule(private val module: Module, width: Double) : ElementWidth(width) {
    ...
    override fun render(matrices: MatrixStack?, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        if (components.isNotEmpty()) {
            ...
            matrices.translate(-(this.width - 16), -(this.defaultHeight / 2), 0.0)
            val accentColor = TarasandeMain.instance.clientValues.accentColor.getColor()
