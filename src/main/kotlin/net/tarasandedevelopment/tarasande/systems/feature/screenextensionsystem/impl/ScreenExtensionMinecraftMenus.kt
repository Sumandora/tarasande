...
class ScreenExtensionButtonScreenExtensionMinecraftMenusSleepingChat : ScreenExtensionButton<SleepingChatScreen>("Client wakeup", SleepingChatScreen::class.java) {
...
class ScreenExtensionButtonScreenExtensionMinecraftMenusDeath : ScreenExtensionButton<DeathScreen>("Force respawn", DeathScreen::class.java) {
