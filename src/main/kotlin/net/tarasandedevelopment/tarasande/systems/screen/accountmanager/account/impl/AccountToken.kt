...
class AccountToken : Account() {
    ...
    override fun defaultEnvironment(): Environment = TarasandeMain.managerScreenExtension().get(ScreenExtensionMinecraftMenusAccountManager::class.java).screenBetterSlotListAccountManager.managerEnvironment.get(EnvironmentPresetEasyMC::class.java).create()
