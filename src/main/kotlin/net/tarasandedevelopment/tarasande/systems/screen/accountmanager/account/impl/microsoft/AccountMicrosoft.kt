...
import net.tarasandedevelopment.tarasande.systems.feature.multiplayerfeaturesystem.impl.accountmanager.subscreen.ScreenBetterAzureApps
...
open class AccountMicrosoft : Account() {
    ...
    var azureApp: AzureAppPreset = TarasandeMain.managerMultiplayerFeature().get(MultiplayerFeatureAccountManager::class.java).screenBetterSlotListAccountManager.managerAzureApp.list.first()
