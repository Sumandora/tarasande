package net.tarasandedevelopment.tarasande.systems.screen.clientmenu.clientmenu.`package`
...
import net.tarasandedevelopment.tarasande.systems.base.packagesystem.Package
...
class ScreenBetterSlotListPackages : ScreenBetterSlotList(46, -1, FontWrapper.fontHeight() * 2 + 5) {
    ...
    internal class ScreenBetterSlotListEntryPackage(val `package`: Package) : ScreenBetterSlotListEntry() {
