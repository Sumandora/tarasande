...
import su.mandora.tarasande.screen.widget.panel.UnmodifiablePanel
...
class TestScreen(prevScreen: Screen?) : ScreenBetter(prevScreen) {
    ...
    override fun init() {
        super.init()
        this.addDrawableChild(ClickableWidgetPanel(object : UnmodifiablePanel("Tarasande ist voll cool", 150.0, 150.0, 500.0, 300.0) {
