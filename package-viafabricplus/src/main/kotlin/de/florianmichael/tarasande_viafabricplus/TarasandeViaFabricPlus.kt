    ...
    override fun onInitializeClient() {
        EventDispatcher.add(EventSuccessfulLoad::class.java) {
            ...
            ManagerModule.get(ModuleTickBaseManipulation::class.java).apply {
                val chargeOnIdlePacketSkip = ValueBoolean(this, "Charge on idle packet skip (" + ValueHolder.sendIdlePacket.protocolRange + ")", false, isEnabled = { !ValueHolder.sendIdlePacket.value })
