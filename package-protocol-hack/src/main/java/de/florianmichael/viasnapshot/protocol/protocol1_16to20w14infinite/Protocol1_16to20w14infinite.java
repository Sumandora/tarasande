package de.florianmichael.viasnapshot.protocol.protocol1_16to20w14infinite;
...
import de.florianmichael.viasnapshot.protocol.protocol1_16to20w14infinite.packets.BlockItemPackets20w14infinite;
import de.florianmichael.viasnapshot.protocol.protocol1_16to20w14infinite.packets.EntityPackets20w14infinite;
            ...
            public void registerMap() {
                handler(wrapper -> {
                    ...
                    if (playerAbilitiesProvider == null) {
                        throw new IllegalStateException("ViaSnapshot doesn't have PlayerAbilitiesProvider?");
                    }
