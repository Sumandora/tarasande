...
public enum ClientboundPackets1_0 implements ClientboundPacketType, PreNettyPacketType {
    ...
    private static final ClientboundPackets1_0[] REGISTRY = new ClientboundPackets1_0[256];

    static {
        for (ClientboundPackets1_0 packet : values()) {
            REGISTRY[packet.id] = packet;
        }
    }

    public static ClientboundPackets1_0 getPacket(final int id) {
        return REGISTRY[id];
    }
    ...
    ClientboundPackets1_0(final int id, final BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
