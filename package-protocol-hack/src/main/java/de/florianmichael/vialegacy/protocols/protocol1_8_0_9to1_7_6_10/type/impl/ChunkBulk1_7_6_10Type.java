...
public class ChunkBulk1_7_6_10Type extends PartialType<Chunk[], ClientWorld> {
    ...
    public Chunk[] read(ByteBuf input, ClientWorld world) throws Exception {
        ...
        final boolean skyLightSent = input.readBoolean();
        ...
        for (i = 0; i < columnCount; i++) {
            chunks[i] = Chunk1_7_6_10Type.deserialize(chunkX[i], chunkZ[i], true, skyLightSent, primaryBitMask[i], addBitMask[i], inflatedBuffers[i]);
        }
