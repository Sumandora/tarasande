package de.florianmichael.clampclient.injection.mixin.protocolhack.viaversion.protocol1_13to1_12_2;
...
public abstract class MixinAbstractFenceConnectionHandler {
    ...
    @Shadow public abstract int getBlockData(UserConnection user, com.viaversion.viaversion.api.minecraft.Position position);
    ...
    public byte getStates(UserConnection user, Position position, int blockState) {
        byte states = 0;
        boolean pre1_12 = ViaLoadingBase.getTargetVersion().isOlderThan(VersionListEnum.r1_12);
