package de.florianmichael.viabedrock.baseprotocol;
            ...
            public void registerMap() {
                handler(wrapper -> {
                    ...
                    CompletableFuture.runAsync(() -> {
                        bedrockSessionStorage.getBedrockClient().ping(bedrockSessionStorage.getTargetAddress()).whenComplete((bedrockPong, throwable) -> {
                            if (throwable != null) {
                            ...
                            versionObject.addProperty("protocol", ViaBedrock.getConfig().isSendNativeVersionInPing() ? ViaBedrock.getConfig().getNativeVersion() : bedrockPong.getProtocolVersion());
