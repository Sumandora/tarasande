...
import de.florianmichael.viacursed.ViaCursedConfigImpl;
...
public interface ViaCursedPlatform {
    ...
    default void init() {
        final ViaCursedConfigImpl config = new ViaCursedConfigImpl(new File(getDataFolder(), "viacursed.yml"));
        config.reloadConfig();

        ViaCursed.init(this, config);
        ...
        Via.getManager().getProtocolManager().registerProtocol(new Protocol1_19_3toBedrock1_19_51(), ProtocolVersion.v1_19_3, CursedProtocols.rBedrock1_19_51);
